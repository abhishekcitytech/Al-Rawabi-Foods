...
//  AlRawabi
//
//  Created by SandipanMacmini on 01/11/22.
//
...
class CreateOrderViewController: UIViewController
{
    ...
    var cardPaymentCtrl:Subscriptionpaymentmethod?
    ...
    func createOrder()
    {
        ...
        orderRequest = OrderRequest(action: "SALE", amount: OrderAmount(currencyCode: "AED", value:amount ), emailAddress: bemail, firstname: bfirstName, lastname: blastName)
