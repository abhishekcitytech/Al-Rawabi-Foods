//
//  monthlyproductcatalogue.swift
//  AlRawabi
//
//  Created by SandipanMacmini on 21/09/22.
//

import UIKit
import CoreData

class monthlyproductcatalogue: UIViewController,UITextFieldDelegate,UICollectionViewDelegate,UICollectionViewDataSource
{
    ...
    var reuseIdentifier1 = "cellcolmonthlyproduct"
    var msg = ""
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        ...
        if collectionView == colorderon
        {
            ...
            if flttotalprice == 0.00{
                ...
                cellA.lbltotalprice.text = String(format: "%@ %0.2f",appDel.changeLanguage(key: "msg_language481"), flttotalprice)
            }
    ...
    //MARK: - Fetch Monthlymodel data Weekly exist or not
