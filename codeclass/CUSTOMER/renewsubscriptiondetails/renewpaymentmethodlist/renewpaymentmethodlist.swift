...
class renewpaymentmethodlist: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UITextFieldDelegate,CardPaymentDelegate,UITableViewDelegate,UITableViewDataSource
{
                    ...
                    DispatchQueue.main.async { [self] in
                        ...
                        if strsuccess == true
                        {
                            ...
                            if self.strselectedpaymentmethodID.containsIgnoreCase("ngeniusonline")
                            {
                                ...
                                print("self.strgrandtotalamount",self.strgrandtotalamount)
    ...
    //MARK: - press CREDITCARD / WALLET PAYMENT  method
    @IBAction func presspayment(_ sender: Any)
    {
       //Call Subscription Card Payment Create
        self.createorderDataRENEWMODELSubscription()
    }
    ...
    @IBAction func pressrechargewallet(_ sender: Any)
    {
        ...
        ctrl.strpageFromPayment = "1022"
        self.navigationController?.pushViewController(ctrl, animated: true)
    }
    
    
    //MARK: - create RENEWMODEL Subscription Create Order Data
    @objc func createorderDataRENEWMODELSubscription()
    {
        print("Previous SubscriptionId",strSubscriptionID)
        print("strautorenew",strautorenew)
        print("strpaymentype",strpaymentype)
        ...
        dicCREATEORDER.setValue(strplanid, forKey: "plan_id")
        ...
        dicCREATEORDER.setValue(strautorenew, forKey: "is_auto_renewal")
        ...
        //FETCH DATE LIST FROM Renewmodel TABLE
        ...
        fetchData.predicate = NSPredicate(format: "userid == %@ && subscriptionid == %@", strcustomerid,strplanid)
        do {
        ...
        for jj in 0 ..< arrMDateBlock.count
        {
            ...
            if day1 == "0"{
                ...
                strdaynamee = "Wednesday"
            }
            else if day1 == "4"{
                strdaynamee = "Thursday"
            }
            else if day1 == "5"{
                strdaynamee = "Friday"
            }
            else if day1 == "6"{
                strdaynamee = "Saturday"
            }
            ...
            dictemp1.setValue(strdaynamee, forKey: "day")
    ...
    //MARK: - remove local DB Renew Method
    func removewlocalDBRenew()
    {
