//
//  CreateOrderViewControllerRN.swift
//  AlRawabi
//
...
class CreateOrderViewControllerRN: UIViewController
{
    ...
    //let saveCard:NSDictionary?
    var cardPaymentCtrl:renewpaymentmethodlist?
    ...
    func createOrder()
    {
        ...
        var orderRequest:OrderRequest3

        orderRequest = OrderRequest3(action: "SALE", amount: OrderAmount3(currencyCode: "AED", value:amount ), emailAddress: bemail, firstname: bfirstName, lastname: blastName)
