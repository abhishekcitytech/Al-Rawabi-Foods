...
class couponlist: UIViewController,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource
{
                        ...
                        if strsuccess == true
                        {
                            ...
                            uiAlert.addAction(UIAlertAction(title: myAppDelegate.changeLanguage(key: "msg_language76"), style: .default, handler: { action in
                                ...
                                for controller in vc {
                                   if controller.isKind(of: cartlistorderonce.self) {
