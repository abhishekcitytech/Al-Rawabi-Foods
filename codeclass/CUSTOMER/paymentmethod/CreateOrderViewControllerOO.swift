//
//  CreateOrderViewControllerOO.swift
//  AlRawabi
//
...
class CreateOrderViewControllerOO: UIViewController
{
    ...
    var cardPaymentCtrl:paymentmethod?
    ...
    func createOrder()
    {
        ...
        var orderRequest:Orderrequest1
        
        orderRequest = Orderrequest1(action: "SALE", amount: Orderamount1(currencyCode: "AED", value:amount ), emailAddress: bemail, firstname: bfirstName, lastname: blastName)
