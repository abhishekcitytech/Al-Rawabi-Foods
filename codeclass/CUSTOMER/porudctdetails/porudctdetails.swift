...
class porudctdetails: BaseViewController,UIScrollViewDelegate,ImageSlideshowDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UITableViewDelegate,UITableViewDataSource, UIWebViewDelegate, WKUIDelegate, WKNavigationDelegate
{
                    ...
                    DispatchQueue.main.async {
                        ...
                        if strsuccess == true
                        {
                            ...
                            if fltTotalmeanscore != 0.0{
                                ...
                                self.lbltotalratingcount.text = String(format: "%.0f %@", 0.0,myAppDelegate.changeLanguage(key: "msg_language329"))
                                self.lbltotalcountglobal.text = String(format: "%@ %@", strTotalVotesCount,myAppDelegate.changeLanguage(key: "msg_language156"))
