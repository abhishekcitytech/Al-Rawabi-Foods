...
class maidaddresslist: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    ...
    //MARK: - get Maid address list API method
    func getcustomeraddresslist()
    {
        ...
        strconnurl = String(format: "%@%@?language=%@", Constants.conn.ConnUrl, Constants.methodname.apimethod78,"")
                ...
                if let json = try JSONSerialization.jsonObject(with: data!) as? NSDictionary
                {
                    ...
                    DispatchQueue.main.async {
                        ...
                        if strsuccess == true
                        {
                            ...
                            self.arrMmyaddresslist = NSMutableArray(array: aarrm1)
