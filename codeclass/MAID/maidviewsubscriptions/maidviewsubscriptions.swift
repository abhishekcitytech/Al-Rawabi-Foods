...
class maidviewsubscriptions: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        let obj = viewsubscriptiondetails(nibName: "viewsubscriptiondetails", bundle: nil)
    ...
    func getallmysubscription()
    {
        ...
        strconnurl = String(format: "%@%@?language=%@", Constants.conn.ConnUrl, Constants.methodname.apimethod80,strLangCode)
